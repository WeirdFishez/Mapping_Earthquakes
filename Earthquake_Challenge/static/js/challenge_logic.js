...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  L.geoJson(data, {
    ...
    // We set the style for each circleMarker using our styleInfo1 function.
    style: styleInfo1,
  ...
  var tectBound = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"

  d3.json(tectBound).then(function (data) {
    console.log(data);
